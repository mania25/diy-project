...
Cleanups are performed in the reverse order they were registered. That is\-: Last In, First Out. A cleanup function can safely allocate memory from the pool that is being cleaned up. It can also safely register additional cleanups which will be run L\-I\-F\-O, directly after the current cleanup terminates. Cleanups have to take caution in calling functions that create subpools. Subpools, created during cleanup will N\-O\-T automatically be cleaned up. In other words, cleanups are to clean up after themselves. 

\subsection{Function Documentation}
\hypertarget{group___pool_cleanup_ga7197fa6b43d9c5e99de17e0e900989ea}{\index{Pool Cleanup Functions@{Pool Cleanup Functions}!apr\-\_\-pool\-\_\-child\-\_\-cleanup\-\_\-set@{apr\-\_\-pool\-\_\-child\-\_\-cleanup\-\_\-set}}
...
\subsubsection[{apr\-\_\-pool\-\_\-child\-\_\-cleanup\-\_\-set}]{\setlength{\rightskip}{0pt plus 5cm}void apr\-\_\-pool\-\_\-child\-\_\-cleanup\-\_\-set (
...
)}}\label{group___pool_cleanup_ga7197fa6b43d9c5e99de17e0e900989ea}
...
\hline
\end{DoxyParams}
\hypertarget{group___pool_cleanup_ga1726cc585bda8997fcb0828f884be55b}{\index{Pool Cleanup Functions@{Pool Cleanup Functions}!apr\-\_\-pool\-\_\-cleanup\-\_\-for\-\_\-exec@{apr\-\_\-pool\-\_\-cleanup\-\_\-for\-\_\-exec}}
\index{apr\-\_\-pool\-\_\-cleanup\-\_\-for\-\_\-exec@{apr\-\_\-pool\-\_\-cleanup\-\_\-for\-\_\-exec}!Pool Cleanup Functions@{Pool Cleanup Functions}}
\subsubsection[{apr\-\_\-pool\-\_\-cleanup\-\_\-for\-\_\-exec}]{\setlength{\rightskip}{0pt plus 5cm}void apr\-\_\-pool\-\_\-cleanup\-\_\-for\-\_\-exec (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)}}\label{group___pool_cleanup_ga1726cc585bda8997fcb0828f884be55b}
Run all registered child cleanups, in preparation for an exec() call in a forked child -- close files, etc., but {\itshape don't} flush I/\-O buffers, {\itshape don't} wait for subprocesses, and {\itshape don't} free any memory. \hypertarget{group___pool_cleanup_gadc59bf32a0302e34fa0a2663f6e48a44}{\index{Pool Cleanup Functions@{Pool Cleanup Functions}!apr\-\_\-pool\-\_\-cleanup\-\_\-kill@{apr\-\_\-pool\-\_\-cleanup\-\_\-kill}}
\index{apr\-\_\-pool\-\_\-cleanup\-\_\-kill@{apr\-\_\-pool\-\_\-cleanup\-\_\-kill}!Pool Cleanup Functions@{Pool Cleanup Functions}}
\subsubsection[{apr\-\_\-pool\-\_\-cleanup\-\_\-kill}]{\setlength{\rightskip}{0pt plus 5cm}void apr\-\_\-pool\-\_\-cleanup\-\_\-kill (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-pool\-\_\-t} $\ast$}]{p, }
\item[{const void $\ast$}]{data, }
\item[{{\bf apr\-\_\-status\-\_\-t}($\ast$)(void $\ast$)}]{cleanup}
\end{DoxyParamCaption}
)}}\label{group___pool_cleanup_gadc59bf32a0302e34fa0a2663f6e48a44}
...
\end{DoxyRemark}
\hypertarget{group___pool_cleanup_gaa211acee585df08f396a50b0ea489b02}{\index{Pool Cleanup Functions@{Pool Cleanup Functions}!apr\-\_\-pool\-\_\-cleanup\-\_\-null@{apr\-\_\-pool\-\_\-cleanup\-\_\-null}}
\index{apr\-\_\-pool\-\_\-cleanup\-\_\-null@{apr\-\_\-pool\-\_\-cleanup\-\_\-null}!Pool Cleanup Functions@{Pool Cleanup Functions}}
\subsubsection[{apr\-\_\-pool\-\_\-cleanup\-\_\-null}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-pool\-\_\-cleanup\-\_\-null (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{data}
\end{DoxyParamCaption}
)}}\label{group___pool_cleanup_gaa211acee585df08f396a50b0ea489b02}
...
\hline
\end{DoxyParams}
\hypertarget{group___pool_cleanup_ga6bdb28224dfe08160cbe3ba6b22dcbd7}{\index{Pool Cleanup Functions@{Pool Cleanup Functions}!apr\-\_\-pool\-\_\-cleanup\-\_\-register@{apr\-\_\-pool\-\_\-cleanup\-\_\-register}}
\index{apr\-\_\-pool\-\_\-cleanup\-\_\-register@{apr\-\_\-pool\-\_\-cleanup\-\_\-register}!Pool Cleanup Functions@{Pool Cleanup Functions}}
\subsubsection[{apr\-\_\-pool\-\_\-cleanup\-\_\-register}]{\setlength{\rightskip}{0pt plus 5cm}void apr\-\_\-pool\-\_\-cleanup\-\_\-register (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-pool\-\_\-t} $\ast$}]{p, }
\item[{const void $\ast$}]{data, }
\item[{{\bf apr\-\_\-status\-\_\-t}($\ast$)(void $\ast$)}]{plain\-\_\-cleanup, }
\item[{{\bf apr\-\_\-status\-\_\-t}($\ast$)(void $\ast$)}]{child\-\_\-cleanup}
\end{DoxyParamCaption}
)}}\label{group___pool_cleanup_ga6bdb28224dfe08160cbe3ba6b22dcbd7}
...
\hline
\end{DoxyParams}
\hypertarget{group___pool_cleanup_gabf3913823af6015895a726ab738eaac5}{\index{Pool Cleanup Functions@{Pool Cleanup Functions}!apr\-\_\-pool\-\_\-cleanup\-\_\-run@{apr\-\_\-pool\-\_\-cleanup\-\_\-run}}
\index{apr\-\_\-pool\-\_\-cleanup\-\_\-run@{apr\-\_\-pool\-\_\-cleanup\-\_\-run}!Pool Cleanup Functions@{Pool Cleanup Functions}}
\subsubsection[{apr\-\_\-pool\-\_\-cleanup\-\_\-run}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-pool\-\_\-cleanup\-\_\-run (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-pool\-\_\-t} $\ast$}]{p, }
\item[{void $\ast$}]{data, }
\item[{{\bf apr\-\_\-status\-\_\-t}($\ast$)(void $\ast$)}]{cleanup}
\end{DoxyParamCaption}
)}}\label{group___pool_cleanup_gabf3913823af6015895a726ab738eaac5}
...
\hline
\end{DoxyParams}
\hypertarget{group___pool_cleanup_ga64114542989d8872c7fd3c62f2a68678}{\index{Pool Cleanup Functions@{Pool Cleanup Functions}!apr\-\_\-pool\-\_\-pre\-\_\-cleanup\-\_\-register@{apr\-\_\-pool\-\_\-pre\-\_\-cleanup\-\_\-register}}
...
\subsubsection[{apr\-\_\-pool\-\_\-pre\-\_\-cleanup\-\_\-register}]{\setlength{\rightskip}{0pt plus 5cm}void apr\-\_\-pool\-\_\-pre\-\_\-cleanup\-\_\-register (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-pool\-\_\-t} $\ast$}]{p, }
\item[{const void $\ast$}]{data, }
\item[{{\bf apr\-\_\-status\-\_\-t}($\ast$)(void $\ast$)}]{plain\-\_\-cleanup}
\end{DoxyParamCaption}
)}}\label{group___pool_cleanup_ga64114542989d8872c7fd3c62f2a68678}
Register a function to be called when a pool is cleared or destroyed.

Unlike apr\-\_\-pool\-\_\-cleanup\-\_\-register which registers a cleanup that is called A\-F\-T\-E\-R all subpools are destroyed, this function registers a function that will be called before any of the subpools are destroyed.
