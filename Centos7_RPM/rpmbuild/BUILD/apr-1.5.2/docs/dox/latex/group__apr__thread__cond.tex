...
\hypertarget{group__apr__thread__cond_gae8f918d38bf1c58bc09670eee456ae5e}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-t@{apr\-\_\-thread\-\_\-cond\-\_\-t}}
\index{apr\-\_\-thread\-\_\-cond\-\_\-t@{apr\-\_\-thread\-\_\-cond\-\_\-t}!Condition Variable Routines@{Condition Variable Routines}}
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-t}]{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf apr\-\_\-thread\-\_\-cond\-\_\-t} {\bf apr\-\_\-thread\-\_\-cond\-\_\-t}}}\label{group__apr__thread__cond_gae8f918d38bf1c58bc09670eee456ae5e}
Opaque structure for thread condition variables 

\subsection{Function Documentation}
\hypertarget{group__apr__thread__cond_gafbbedd2a07629fe3186343035ae83152}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-broadcast@{apr\-\_\-thread\-\_\-cond\-\_\-broadcast}}
...
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-broadcast}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-thread\-\_\-cond\-\_\-broadcast (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-thread\-\_\-cond\-\_\-t} $\ast$}]{cond}
\end{DoxyParamCaption}
)}}\label{group__apr__thread__cond_gafbbedd2a07629fe3186343035ae83152}
...
\end{DoxyRemark}
\hypertarget{group__apr__thread__cond_gab39e8b722d46d23466e9e346ada85a7f}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-create@{apr\-\_\-thread\-\_\-cond\-\_\-create}}
\index{apr\-\_\-thread\-\_\-cond\-\_\-create@{apr\-\_\-thread\-\_\-cond\-\_\-create}!Condition Variable Routines@{Condition Variable Routines}}
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-create}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-thread\-\_\-cond\-\_\-create (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-thread\-\_\-cond\-\_\-t} $\ast$$\ast$}]{cond, }
\item[{{\bf apr\-\_\-pool\-\_\-t} $\ast$}]{pool}
\end{DoxyParamCaption}
)}}\label{group__apr__thread__cond_gab39e8b722d46d23466e9e346ada85a7f}
...
\hline
\end{DoxyParams}
\hypertarget{group__apr__thread__cond_ga049e646e23c670f3a79fe25401b9c1b0}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-destroy@{apr\-\_\-thread\-\_\-cond\-\_\-destroy}}
...
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-destroy}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-thread\-\_\-cond\-\_\-destroy (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-thread\-\_\-cond\-\_\-t} $\ast$}]{cond}
\end{DoxyParamCaption}
)}}\label{group__apr__thread__cond_ga049e646e23c670f3a79fe25401b9c1b0}
Destroy the condition variable and free the associated memory. 
\begin{DoxyParams}{Parameters}
{\em cond} & the condition variable to destroy. \\
\hline
\end{DoxyParams}
\hypertarget{group__apr__thread__cond_gafc2d7f2907eb12e5543c971a4c0140ee}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-pool\-\_\-get@{apr\-\_\-thread\-\_\-cond\-\_\-pool\-\_\-get}}
...
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-pool\-\_\-get}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-pool\-\_\-t}$\ast$ apr\-\_\-thread\-\_\-cond\-\_\-pool\-\_\-get (
\begin{DoxyParamCaption}
\item[{const {\bf apr\-\_\-thread\-\_\-cond\-\_\-t} $\ast$}]{thethread\-\_\-cond}
\end{DoxyParamCaption}
)}}\label{group__apr__thread__cond_gafc2d7f2907eb12e5543c971a4c0140ee}
Get the pool used by this thread\-\_\-cond. \begin{DoxyReturn}{Returns}
apr\-\_\-pool\-\_\-t the pool 
\end{DoxyReturn}
\hypertarget{group__apr__thread__cond_gadf7ad6c2731bc6128f969d3efc7ff5eb}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-signal@{apr\-\_\-thread\-\_\-cond\-\_\-signal}}
\index{apr\-\_\-thread\-\_\-cond\-\_\-signal@{apr\-\_\-thread\-\_\-cond\-\_\-signal}!Condition Variable Routines@{Condition Variable Routines}}
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-signal}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-thread\-\_\-cond\-\_\-signal (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-thread\-\_\-cond\-\_\-t} $\ast$}]{cond}
\end{DoxyParamCaption}
)}}\label{group__apr__thread__cond_gadf7ad6c2731bc6128f969d3efc7ff5eb}
...
If no threads are waiting on the condition variable, nothing happens. 
\end{DoxyRemark}
\hypertarget{group__apr__thread__cond_ga67f2feecb7fa1929cc9b354dafd00306}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-timedwait@{apr\-\_\-thread\-\_\-cond\-\_\-timedwait}}
...
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-timedwait}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-thread\-\_\-cond\-\_\-timedwait (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-thread\-\_\-cond\-\_\-t} $\ast$}]{cond, }
\item[{{\bf apr\-\_\-thread\-\_\-mutex\-\_\-t} $\ast$}]{mutex, }
\item[{{\bf apr\-\_\-interval\-\_\-time\-\_\-t}}]{timeout}
\end{DoxyParamCaption}
)}}\label{group__apr__thread__cond_ga67f2feecb7fa1929cc9b354dafd00306}
...
\hline
{\em timeout} & The amount of time in microseconds to wait. This is a maximum, not a minimum. If the condition is signaled, we will wake up before this time, otherwise the error A\-P\-R\-\_\-\-T\-I\-M\-E\-U\-P is returned. \\
\hline
\end{DoxyParams}
\hypertarget{group__apr__thread__cond_ga789719a5f02bdab8b8abbc8bddd0406b}{\index{Condition Variable Routines@{Condition Variable Routines}!apr\-\_\-thread\-\_\-cond\-\_\-wait@{apr\-\_\-thread\-\_\-cond\-\_\-wait}}
\index{apr\-\_\-thread\-\_\-cond\-\_\-wait@{apr\-\_\-thread\-\_\-cond\-\_\-wait}!Condition Variable Routines@{Condition Variable Routines}}
\subsubsection[{apr\-\_\-thread\-\_\-cond\-\_\-wait}]{\setlength{\rightskip}{0pt plus 5cm}{\bf apr\-\_\-status\-\_\-t} apr\-\_\-thread\-\_\-cond\-\_\-wait (
\begin{DoxyParamCaption}
\item[{{\bf apr\-\_\-thread\-\_\-cond\-\_\-t} $\ast$}]{cond, }
\item[{{\bf apr\-\_\-thread\-\_\-mutex\-\_\-t} $\ast$}]{mutex}
\end{DoxyParamCaption}
)}}\label{group__apr__thread__cond_ga789719a5f02bdab8b8abbc8bddd0406b}
